...
const auto modulo = Library::Util::Arithmetic::getModuloFunction(1'000'000'007);
...
int Library::LeetCode::LC3352::countKReducibleNumbers(const std::string &s, const int k) {
