...
Library::LeetCode::LC460::LFUCache::LFUCache(const int capacity) : capacity(capacity), size(0) {
}

int Library::LeetCode::LC460::LFUCache::get(const int key) {
    increaseFrequency(key);
    return read(key);
}

void Library::LeetCode::LC460::LFUCache::put(const int key, const int value) {
...
int Library::LeetCode::LC460::LFUCache::read(const int key) {
...
void Library::LeetCode::LC460::LFUCache::write(const int key, const int value) {
    if (const auto itr = keyIteratorPairMap.find(key);
        itr != keyIteratorPairMap.end()) {
...
void Library::LeetCode::LC460::LFUCache::increaseFrequency(const int key) {
...
void Library::LeetCode::LC460::LFUCache::evict() {
