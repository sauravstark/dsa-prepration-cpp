...
int Codeforces::Problems::CF1552F::telepanting(const std::vector<int> &src, const std::vector<int> &des,
                                               const std::vector<int> &state) {
    const auto modulo = Common::Util::Arithmetic::getModuloFunction(998244353);
